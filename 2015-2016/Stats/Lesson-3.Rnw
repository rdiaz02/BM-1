...
I've used \Rfunction{anova} but I could have used \Rfunction{Anova}, and
the above applies to more than one factor, and to factors with an
...
are special types of linear models.
