...
\begin{frame}
  ...
  \item If problems with Moodle, come tomorrow Tuesday 15 to Seminarios 4
    and 5, from 10:00 to 12:00 (better if you are there at 10:00).
  \end{itemize}
\end{frame}
...
\begin{frame}
  \frametitle{Schedule}
  \begin{itemize}
  \item Available from Moodle. There are two groups. You should know (have
    been told) which one you belong to.
  \end{itemize}
\end{frame}
...
%%    \item[I.\ Fariñas' talk] 19-September. Aula Magna. 10:00--12:00.
    \item[First class BM-1] 21 or 22-September. Seminars 4 and 5 (stats)
      and Seminar 9 (scientific communication). 10:00--12:00 and
      12:00--14:00.
    \end{description}
    \vspace*{15pt} 
