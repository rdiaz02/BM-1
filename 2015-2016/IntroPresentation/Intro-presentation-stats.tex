...
\begin{frame}
  \frametitle{Why?}
  Because the world is a noisy place and we need statistics to do science.
...
\begin{frame}
  ...
  \item Understand the fundamental relevance of good experimental design.
  \end{itemize}
\end{frame}
...
{\footnotesize
(Analogy of first aid course vs.\ becoming a neurosurgeon)
}
...
\begin{frame}
  ...
  \item Becoming a key piece in reproducible research
