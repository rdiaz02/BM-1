...
\begin{frame}
  ...
  \item You MUST install several things on your own computer
    \begin{itemize}
...
% or
  Instructions available from Moodle (file ``Software-you-need-to-install.txt'')
  and also from
...
\begin{frame}
  ...
  Please, do work on the notes on your own before coming to class.
