...
\begin{frame}
  \frametitle{What will ideally happen?}
  \begin{itemize}
...
%  Please, please: do it
  ...
  \item (If some of you do work through it and some won't \ldots most
    likely those who don't will be left way behind ---and ``tutorias'' are
...
\begin{frame}
  ...
  \item \textbf{Label your questions appropriately}. 
  \end{itemize}
\end{frame}
...
The title/subject of the question is \textbf{very} important.
  \begin{itemize}
  ...
  \item I don't understand statistics. \textit{Eh? Which part? All of
      statistics? What statistics is about?}
  \item I hate statistics. \textit{Fair enough. Now, what is the question,
    exactly? Or is this just to make us sad?}
...
\begin{frame}
  \frametitle{Forum: attachment and error messages}
  \begin{itemize}
  \item   Whenever possible, copy and paste the error message(s) as text in the
  body of the question.

  \item Avoid capturing screens and pasting them in a word document, power
    point document, or other such thing. 
  \item (Yes, copying and pasting the text error is much simpler and
    faster for you too.)
  \end{itemize}
\end{frame}
