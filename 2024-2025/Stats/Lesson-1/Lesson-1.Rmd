...
author: "Blanca Lizarbe, Department of Biochemistry (UAM), blanca.lizarbe@uam.es; some additions by Ramon Diaz-Uriarte"
output:
...
(Note: the graph below cannot be created directly from R Commander, but we will create a similar one with R Commander later. You can, of course, copy the code in the console and run it)
