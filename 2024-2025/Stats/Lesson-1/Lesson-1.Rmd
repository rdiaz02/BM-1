...
## Using R commander
• Open an R session through the Rgui interface. In th console, type: library(Rcmdr). If is correctly installed, a new window should open that looks like Figure \@ref(fig:Rfigures):
...
It is important to distinguish, for every experimental setup, between technical replicates, biological replicates and sample size. Take a look at Figure \@ref(fig:fig-vaux).
