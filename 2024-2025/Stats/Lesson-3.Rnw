...
Read it very carefully: it makes comparisons very simple; as Wright explains: ``An
...
\item Pearl, Glymour, Jewell, 2016, ``Causal inference in statistics: a primer''
  [Beware of errata: avoid early printings of the book and make sure to look at
