...
Treatment has an effect on Size, when Treatment really does not have an
effect on Size; to put it differently,  U affects Size and U is associated with Treatment when we condition on Fungus.
