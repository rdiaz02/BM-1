...
Before we continue, though, we will use the following two examples, a depressing and an uplifting one. If you understand them, you understand why we need multiple comparisons:
