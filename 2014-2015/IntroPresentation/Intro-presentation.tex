...
\begin{frame}
  \frametitle{RcmdrPlugin.doBy and ISwR}
...
\begin{frame}
  ...
  Why?
\vspace*{15pt}
Because you will learn the material a lot better
\begin{itemize}
\item try it on your own
\item find out what you don't know/understand
...
\item Focused on things you might have forgotten or tricky things you
  might not know
\item And with a strong practical component of ``teach me to do it,
  interpret it, and   produce reports and graphics I can use in my TFM''.
\end{itemize}
...
\begin{itemize}
\item Your colleague is likely to understand better what is it you do
  not understand
\end{itemize}
...
\vspace*{15pt}
  \begin{itemize}
  \item No, we will not be checking it
  \item What you get out of this class depends a lot on what you put into
    this class
  \item If you don't work on this on your own, we will 
    \begin{itemize}
    \item go painfully slow
    \item all end up frustrated
    \end{itemize}
