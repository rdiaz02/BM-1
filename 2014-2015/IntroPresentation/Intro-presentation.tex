...
\begin{frame}
  ...
  \item They even mention it in \textit{Nature} editorials (\textit{The
      digital toolbox}, 4-September-2014).
  \item \ldots
...
% or
  ...
  install'', \Burl{http://ciencias.biomol.uam.es/moodle/mod/resource/view.php?id=560}) and also from
...
\begin{itemize}
\item This the Applied Statistics part of BM-1 should be a quick review \ldots
