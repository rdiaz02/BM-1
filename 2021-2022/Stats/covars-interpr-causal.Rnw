...
<<plot_fungus_3, fig.width = 4, fig.height=1.4, fig.lp='fig:', results = 'hide', echo=FALSE, fig.cap='Fungus, collider example',out.width='9cm',fig.pos="!h">>=
...
``Why are handsome men such jerks?'' ---and, I guess, a similar phenomenon with women: \url{http://www.slate.com/blogs/how_not_to_be_wrong/2014/06/03/berkson_s_fallacy_why_are_handsome_men_such_jerks.html} .}
