...
\begin{frame}
  \frametitle{Taking some to trial and presumption of innocence analogy}
  \begin{description}
  \item[Significance and hypothesis testing] Is there enough evidence to sent this
    person to jail? How likely is, if she/he were innocent, that she/he committed
    the crime?
    \vspace*{15pt}
    
  \item[Estimate] But I really think she is guilty. Or ``but the evidence
    indicates she is guilty (though we cannot show it beyond reasonable doubt)''.
...
{\scriptsize From Miguel Hernán's talk, Causal inference, ``Epidemiological
  Research Methods in the COVID-19 Pandemic'', 2021-06,14. Also García-Albéniz et
...
\begin{frame}
  \frametitle{Wide CIs: problems and interpretations}
  \begin{itemize}
  \item Many papers published with huge CI are papers with no information, basically
  \item But then, that leads to people believen that the drug is not effective
