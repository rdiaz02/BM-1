...
\item Package \CRANpkg{car} and the accompanying book by Fox and Weisberg ``An R
  ...
  comments about those and other diagnostics, and several functions. Read chapter
  8 of that book. It will explain you how to use them as well as possible
  remedial measures. Actually, read the complete book. In the meantime, you can
  also take a look, for a summary, at the very nice sections 8.3 to 8.5 in
  Kabakoff's ``R in action.''
