...
Please, draw a figure with those means, like any of the interaction plots we have
seen in class.  Please, \textbf{really draw that figure}. Actually, \textbf{draw
  2 figures}: the first will have A in the X (abscisas) axis, the second will
have B in the X axis. You will see the lines clearly cross.
