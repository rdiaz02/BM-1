...
This work is Copyright, \copyright, 2014-2021, Ramon Diaz-Uriarte, and is
...
More details about Type I and Type II Sums of Squares are provided in the
Appendix in \ref{ssI-to-III} (but you can skip it). This issue is also discussed,
by focusing on the key issues from an applied perspective, in in chapter 5 of Fox
and Weisberg's ``An R companion to applied regression, 3rd edition''.
...
\Robject{AnovaModel.1}, from section \nameref{oneway}, looks just fine. Please
