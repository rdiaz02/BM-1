...
%%zz FIXME
\subsection{Confidence intervals with multiple regression}\label{regr-ci}

\subsubsection{Confidence intervals for the parameter
  estimates}\label{regr-ci-param}


\subsubsection{Confidence intervals for predictions}\label{regr-ci-pred}
