...
%% Could I just use either one? Nope. For BM-1/2 I am using gitinfo
%% in R-basic-stats gitinfo2. Will move to gitinfo2 everywhere
% \usepackage{gitinfo2}
\usepackage{gitinfo}
...
This work is Copyright, \copyright, 2021-2026, Ramon Diaz-Uriarte, and is
