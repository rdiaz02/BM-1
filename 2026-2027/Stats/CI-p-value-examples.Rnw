...
## with 30 mm margins and Courier, code at \normalsize would only fit
## about 64 characters per line; \small fits the 68 we can produce
...
This work is Copyright, \copyright, 2024-2026, Ramon Diaz-Uriarte, and is
...
A document to clarify the relationship between confidence intervals and p-values, using examples from the two-sample t-test.
