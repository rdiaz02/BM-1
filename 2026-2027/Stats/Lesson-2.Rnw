...
\item What is a deviation from the null that is as extreme as, or more extreme than, the observed one?
  ...
  \item A deviation more extreme is any t-statistic larger than \(2\) (something that goes in the opposite direction from what the null says).
...
\item What is a deviation from the null that is as extreme as, or more extreme than, the observed one?
  ...
  \item We observed \(\bar{X}_A - \bar{X}_B = -2\).
  \item The null says \(\mu_A \le \mu_B\).
  \item A deviation more extreme is any t-statistic larger than \(-2\) (something that goes in the opposite direction).
