...
\title{BM-1: a 3 minute intro}
\subtitle{Critical analysis of scientific
literature. Applied statistics for molecular biosciences (BM-1). 32811}
...
\date[11-09-2020]{11-September-2020\\ {\tiny (Rev: \gitAbbrevHash)}}
...
\begin{frame}
  ...
  \begin{itemize}
  \item ``Critical analysis ...'', CASL 
  \item Applied Statistics (Stats)
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \item Make sure you can access Moodle:
    \Burl{http://posgrado.uam.es}
  \item Make sure you can access Teams.
...
\begin{frame}
  \frametitle{Moodle? Why do I need it?}
  \begin{itemize}
  \item This is the usual UAM moodle: \Burl{https://posgrado.uam.es}.
...
\begin{frame}
  \frametitle{Teams? Why do I need it?}
  \begin{itemize}
  \item \red{We will use it for all on-line classes.}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \item Get your UAM email: all issues to CAU (google for ``UAM cau
    email''). No UAM email, no Moodle. No UAM email, no Teams.
...
\begin{frame}
 ...
 %    \begin{itemize}
 %    \item Only affects exam.
 %    \end{itemize}

 %  \item CASL
 %    \begin{itemize}
 %    \item Bruno Sainz
 %    \item \red{\LARGE \textbf{16-September, 10:00 am, Aula Magna}}
 %    \item {\Large You \textbf{MUST} read ``CASL Student Guide 2019-2020''
 %      (available from Moodle) before 16 September.}
 %    \item There are subgroups (see above).
 %    \item Has major effects!
 %    \item Pay attention to Schedule!
 %    \end{itemize}
    
 % % E.g., Applied statistics, 24, 25, and
...
% %%    \item[I.\ Fariñas' talk] 19-September. Aula Magna. 10:00--12:00.
...
% \vspace*{15pt}
% Remember also \textbf{Acto Apertura Máster}, 1-October, Facultad Ciencias,
% Salón Actos, Edificio Biología.
% \end{frame}
